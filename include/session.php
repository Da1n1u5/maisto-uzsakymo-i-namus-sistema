...
class Session {
     ...
     */
    function register($subuser, $subpass, $subname, $subSurname, $subemail, $subtelephone, $subcity, $subaddress, $submailCode) {
        ...
        /* No errors, add the new account to the */ else {
            if ($database->addNewUser($subuser, md5($subpass), $subname, $subSurname, $subemail, $subtelephone, $subcity, $subaddress, $submailCode)) {
                if (EMAIL_WELCOME) {
    ...
    function registerEnterprise($enterprisename, $enterpriseoccupation, $subuser, $subpass, $subname, $subSurname, $subemail, $subtelephone, $subcity, $subaddress, $submailCode) {
        global $database, $form, $mailer;  //The database, form and mailer object
        ...
        /* No errors, add the new account to the */ else {
            if ($database->addNewEnterprise($enterprisename, $enterpriseoccupation, $subuser, md5($subpass), $subname, $subSurname, $subemail, $subtelephone, $subcity, $subaddress, $submailCode)) {
                if (EMAIL_WELCOME) {
                    $mailer->sendWelcome($subuser, $subemail, $subpass);
                }
                return 0;  //New user added succesfully
    ...
    function addDishToDatabase($dishname, $type, $servings, $wraping, $price, $filebutton, $name, $weight) {
        global $database;
        $insertion = $database->insertNewDish($dishname, $type, $servings, $wraping, $price, $filebutton, $name, $weight);
        if ($insertion) {
            // $database->
            return 0;
        } else {
