                                    ...
                                    <tr><td>
                                            <form action="process.php" method="POST" class="login">              
                                                ...
                                                <p style="text-align:left;">Pavardė:
                                                    <input class ="s1" name="surname" type="text" size="15"
                                                           value="<?php echo $form->value("surname"); ?>"/><br><?php echo $form->error("surname"); ?>
                                                </p>
                                                <p style="text-align:left;">E-paštas:
                                                 ...
                                                 <p style="text-align:left;">Telefonas:
                                                    <input class ="s1" name="telephone" type="text" size="15"
                                                           value="<?php echo $form->value("telephone"); ?>"/><br><?php echo $form->error("telephone"); ?>
                                                </p>
                                                <p style="text-align:left;">Miestas:
                                                    <input class ="s1" name="city" type="text" size="15"
                                                           value="<?php echo $form->value("city"); ?>"/><br><?php echo $form->error("city"); ?>
                                                </p>
                                                <p style="text-align:left;">Adresas:
                                                    <input class ="s1" name="address" type="text" size="15"
                                                           value="<?php echo $form->value("address"); ?>"/><br><?php echo $form->error("address"); ?>
                                                </p>
                                                <p style="text-align:left;">Pašto kodas:
                                                    <input class ="s1" name="postCode" type="text" size="15"
                                                           value="<?php echo $form->value("postCode"); ?>"/><br><?php echo $form->error("postCode"); ?>
                                                </p>
